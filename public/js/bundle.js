...
var showAlert = function showAlert(type, msg, duration) {
  hideAlert();
        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === "success") {
              (0, _alert.showAlert)('success', 'logged in sucessfully!', 5000);
          ...
          case 8:
            ...
            (0, _alert.showAlert)('error', 'Log In Failed', 5000);
...
var signUp = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(email, password, confrimPassword, name) {
    var data, res;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            (0, _alert.showAlert)('error', 'Sign up Failed', 5000);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Error logging out! Try again.', 5000);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " updated sucessfully!"), 5000);
              window.setTimeout(function () {
                location.assign('/me');
              }, 1500);
            }
          ...
          case 8:
            ...
            (0, _alert.showAlert)('error', 'incorrect data', 5000);
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"paystack.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.bookHotelRoom = void 0;
...
var bookHotelRoom = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("/api/v1/bookings/checkout-session/".concat(hotelId, "/room/").concat(roomId));
  ...
  return function bookHotelRoom(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
var logOutBtn = document.querySelector('.sign-out');
var userDataForm = document.querySelector('#userdata-form');
var userPasswordForm = document.querySelector('#pwd-form');
var bookBtn = document.querySelectorAll('#book-room');
...
if (signUpForm) {
  signUpForm.addEventListener('submit', function (e) {
    ...
    var email = document.getElementById('email').value;
    var password = document.getElementById('pwd').value;
    var confrimPassword = document.getElementById('cpwd').value;
    (0, _auth.signUp)(email, password, confrimPassword, name);
  });
}
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              passwordCurrent = document.getElementById('pwd').value;
              password = document.getElementById('newpwd').value;
              passwordConfirm = document.getElementById('confirmpwd').value;
              ...
              return _context.abrupt("return", (0, _alert.showAlert)('error', 'Password length is less than 8', 5000));
            ...
            case 9:
              document.getElementById('pwd-btn').textContent = 'Save Password', document.getElementById('pwd').value = '', document.getElementById('newpwd').value = '', document.getElementById('confirmpwd').value = '';
